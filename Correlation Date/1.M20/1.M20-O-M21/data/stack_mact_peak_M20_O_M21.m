...
display_start_sec = 1.0; % 计算域时间>展示域
display_end_sec = 1.2;
start_sec = 1.025; % 展示域时间
end_sec = 1.075;
...
figure;
plot3(Time_p,Date_p,snr_x,'-','linew',0.8,'color','k');hold on;
...
% plot3(Time_m4,Date_m4,snr_m4,'o','markersize',8,'linew',2,'MarkerFaceColor','#003051','color','#003051');hold on;
% rectangle('position',[1.025 Date_p(1,1) 0.015 20],'FaceColor',[0.9 0.9 0.9]);hold on;
view([0 80]);
...
%% save
for inum = 1 : 4%ｸﾝｷ袒ｵﾊ�ﾁｿﾈｷｶｨ
    eval(['dateM20_O_M21_m',num2str(inum),' = Date_m',num2str(inum),';']);
    eval(['snrM20_O_M21_m',num2str(inum),' = snr_m',num2str(inum),';']);
    eval(['timeM20_O_M21_m',num2str(inum),' = Time_m',num2str(inum),';']);
end
Time_M20_O_M21 = Time_p;
Date_M20_O_M21 = Date_p;
snr_M20_O_M21 = snr_x;
save M20_O_M21_4peak dateM20_O_M21_m1 dateM20_O_M21_m2 dateM20_O_M21_m3 dateM20_O_M21_m4...
    snrM20_O_M21_m1 snrM20_O_M21_m2 snrM20_O_M21_m3 snrM20_O_M21_m4...
    timeM20_O_M21_m1 timeM20_O_M21_m2 timeM20_O_M21_m3 timeM20_O_M21_m4... 
    Time_M20_O_M21 Date_M20_O_M21 snr_M20_O_M21;
