...
display_start_sec = 2.5 % 计算域时间>展示域
display_end_sec = 2.7
start_sec = 2.53; % 展示域时间
end_sec = 2.61;
...
for inum = 1 : 3%ｸﾝｷ袒ｵﾊ�ﾁｿﾈｷｶｨ
    eval(['dateM23_O_M20_m',num2str(inum),' = Date_m',num2str(inum),';'])
    eval(['snrM23_O_M20_m',num2str(inum),' = snr_m',num2str(inum),';'])
    eval(['timeM23_O_M20_m',num2str(inum),' = Time_m',num2str(inum),';'])
end
Time_M23_O_M20 = Time_p;
Date_M23_O_M20 = Date_p;
snr_M23_O_M20 = snr_x;
save M23_O_M20_4peak dateM23_O_M20_m1 dateM23_O_M20_m2 dateM23_O_M20_m3...
    snrM23_O_M20_m1 snrM23_O_M20_m2 snrM23_O_M20_m3 ...
    timeM23_O_M20_m1 timeM23_O_M20_m2 timeM23_O_M20_m3 ... 
    Time_M23_O_M20 Date_M23_O_M20 snr_M23_O_M20;
