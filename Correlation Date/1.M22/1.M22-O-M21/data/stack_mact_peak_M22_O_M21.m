...
display_start_sec = 1.15 % 计算域时间>展示域
display_end_sec = 1.3
start_sec = 1.185; % 展示域时间
end_sec = 1.215;
...
for inum = 1 : 2%ｸﾝｷ袒ｵﾊ�ﾁｿﾈｷｶｨ
    eval(['dateM22_O_M21_m',num2str(inum),' = Date_m',num2str(inum),';'])
    eval(['snrM22_O_M21_m',num2str(inum),' = snr_m',num2str(inum),';'])
    eval(['timeM22_O_M21_m',num2str(inum),' = Time_m',num2str(inum),';'])
end
Time_M22_O_M21 = Time_p;
Date_M22_O_M21 = Date_p;
snr_M22_O_M21 = snr_x;
save M22_O_M21_4peak dateM22_O_M21_m1 dateM22_O_M21_m2 ...
    snrM22_O_M21_m1 snrM22_O_M21_m2 ...
    timeM22_O_M21_m1 timeM22_O_M21_m2 ... 
    Time_M22_O_M21 Date_M22_O_M21 snr_M22_O_M21;
