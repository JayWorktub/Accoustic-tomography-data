...
display_start_sec = 2.1 % 计算域时间>展示域
display_end_sec = 2.2
start_sec = 2.142; % 展示域时间
end_sec = 2.152;
...
% plot3(Time_m3,Date_m3,snr_m3,'bo','markersize',10,'linew',2);hold on;
...
%% save
for inum = 1 : 2%ｸﾝｷ袒ｵﾊ�ﾁｿﾈｷｶｨ
    eval(['dateM22_O_M20_m',num2str(inum),' = Date_m',num2str(inum),';'])
    eval(['snrM22_O_M20_m',num2str(inum),' = snr_m',num2str(inum),';'])
    eval(['timeM22_O_M20_m',num2str(inum),' = Time_m',num2str(inum),';'])
end
Time_M22_O_M20 = Time_p;
Date_M22_O_M20 = Date_p;
snr_M22_O_M20 = snr_x;
save M22_O_M20_4peak dateM22_O_M20_m1 dateM22_O_M20_m2 ...
    snrM22_O_M20_m1 snrM22_O_M20_m2 ...
    timeM22_O_M20_m1 timeM22_O_M20_m2 ... 
    Time_M22_O_M20 Date_M22_O_M20 snr_M22_O_M20;
